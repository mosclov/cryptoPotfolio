...
class CryptosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crypto" do
    assert_difference('Crypto.count') do
      post cryptos_url, params: { crypto: { investment: @crypto.investment, name: @crypto.name, qty: @crypto.qty } }
    end
  ...
  test "should update crypto" do
    patch crypto_url(@crypto), params: { crypto: { investment: @crypto.investment, name: @crypto.name, qty: @crypto.qty } }
